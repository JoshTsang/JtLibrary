...
import com.joshtttt.photoselector.ui.PhotoSelectorBaseActivity.OnLocalReccentListener;
...
public class PhotoPreviewActivity extends BasePhotoPreviewActivity implements OnLocalReccentListener {
	...
	protected void init(Bundle extras) {
		...
		if (extras.containsKey("photos")) { // 预览图片
			...
			if (!CommonUtils.isNull(albumName) && albumName.equals(PhotoSelectorBaseActivity.RECCENT_PHOTO)) {
